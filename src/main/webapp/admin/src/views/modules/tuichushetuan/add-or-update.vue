	...
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#666","borderRadius":"0 0 10px 10px","background":"#fff","width":"calc(100% - 60px)","fontSize":"16px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="社团属性" prop="shetuanshuxing">
					<el-input  v-model="ruleForm.shetuanshuxing" placeholder="社团属性" clearable  :readonly="ro.shetuanshuxing"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="社团属性" prop="shetuanshuxing">
					<el-input v-model="ruleForm.shetuanshuxing" placeholder="社团属性" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="date" v-if="type!='info'" label="退出时间" prop="tuichushijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.tuichushijian" 
						type="datetime"
						:readonly="ro.tuichushijian"
						placeholder="退出时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.tuichushijian" label="退出时间" prop="tuichushijian">
					<el-input v-model="ruleForm.tuichushijian" placeholder="退出时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="退出账号" prop="yonghuzhanghao">
					<el-input  v-model="ruleForm.yonghuzhanghao" placeholder="退出账号" clearable  :readonly="ro.yonghuzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="退出账号" prop="yonghuzhanghao">
					<el-input v-model="ruleForm.yonghuzhanghao" placeholder="退出账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="退出人" prop="yonghuxingming">
					<el-input  v-model="ruleForm.yonghuxingming" placeholder="退出人" clearable  :readonly="ro.yonghuxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="退出人" prop="yonghuxingming">
					<el-input v-model="ruleForm.yonghuxingming" placeholder="退出人" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="退出原因" prop="tuichuyuanyin">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="退出原因"
					  v-model="ruleForm.tuichuyuanyin" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.tuichuyuanyin" label="退出原因" prop="tuichuyuanyin">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.tuichuyuanyin}}</span>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.tuichushijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='tuichuyuanyin'){
							this.ruleForm.tuichuyuanyin = obj[o];
							this.ro.tuichuyuanyin = true;
							continue;
						}
						if(o=='tuichushijian'){
							this.ruleForm.tuichushijian = obj[o];
							this.ro.tuichushijian = true;
							continue;
						}
						if(o=='yonghuzhanghao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tuichushetuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tuichushetuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
