		...
		<div class="attr" :style='{"width":"50%","padding":"0 20px","position":"relative","display":"flex","order":"1"}'>
			...
			<div class="info" :style='{"padding":"10px","margin":"0","background":"#fff","flex":"1"}'>
				...
				<div class="item" :style='{"padding":"2px 10px","margin":"0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","flex":"1","height":"40px"}'>{{detail.title}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","flex":"1","height":"40px"}'>{{detail.subtitle}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"5px","outline":"none","color":"#fff","borderRadius":"4px","background":"#005FBA","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('systemintro','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"1px solid #343434","cursor":"pointer","padding":"0 10px","margin":"5px","outline":"none","color":"#000","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('systemintro','删除')" @click="delClick">删除</el-button>
					<!-- hasPay $hasPay -->
				</div>
			</div>
		</div>
