...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"150px auto 20px","position":"relative","background":"#fff"}'>
    <el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"5px","outline":"none","color":"#fff","borderRadius":"4px","background":"#005FBA","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="warning" size="mini" @click="backClick" class="el-icon-back">返回</el-button>
    <div v-if="storeupType==1" class="section-title" :style='{"width":"100%","margin":"10px 0","fontSize":"20px","lineHeight":"40px","color":"#005fba","textAlign":"center"}'>我的收藏</div>
