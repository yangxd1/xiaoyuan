<template>
	<div :style='{"width":"60%","margin":"150px auto 20px","position":"relative","background":"#fff"}'>
	<div :style='{"width":"calc(100% - 0px)","float":"right"}'>
		<div :style='{"width":"100%","height":"auto"}'>
			<div :style='{"margin":"10px 0","fontSize":"20px","lineHeight":"54px","color":"#005fba","textAlign":"center","background":"#E4F2FF"}'>公告信息</div>
		</div>
		...
		<!-- option -->
		<div :style='{"width":"100%","padding":"20px","justifyContent":"end","display":"flex","height":"auto"}'>
		  <div :style='{"padding":"0 10px","margin":"0 10px","color":"#fff","borderRadius":"20px","background":"#005fba","lineHeight":"40px","fontSize":"14px"}' @click="prepDetailClick">上一篇：prev</div>
		  <div :style='{"padding":"0 10px","lineHeight":"40px","fontSize":"14px","color":"#fff","borderRadius":"20px","background":"#B0B0B0"}' @click="nextDetailClick">下一篇：next</div>
		</div>

		<!-- 热门文章 -->
		<div class="hot" :style='{"width":"100%","margin":"15px 0","background":"#fff","height":"auto"}'>
		  <div :style='{"width":"100%","padding":"0 20px","lineHeight":"44px","fontSize":"14px","color":"#005fba","background":"#E4F2FF"}'>热门文章</div>
		  <div :style='{"width":"100%","padding":"20px","background":"#fff","justifyContent":"space-around","display":"flex","height":"auto"}'>
		    <div v-for="item in hotList" :key="item.id" :style='{"width":"23%","padding":"0","textAlign":"center","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
		      <img :style='{"width":"100%","objectFit":"cover","display":"block","height":"120px"}' :src="baseUrl + item.picture" alt="">
		      <div :style='{"padding":"4px 5px 0","lineHeight":"20px","fontSize":"15px","color":"#000"}'>{{ item.title }}</div>
		      <div :style='{"padding":"0 5px","lineHeight":"20px","fontSize":"12px","color":"#999"}'>{{item.addtime}}</div>
		    </div>
		  </div>
		</div>
		<!-- 推荐文章 -->
		<div class="news" :style='{"width":"100%","margin":"15px 0","background":"#fff","height":"auto"}'>
		  <div :style='{"width":"100%","padding":"0 20px","lineHeight":"44px","fontSize":"14px","color":"#005fba","background":"#E4F2FF"}'>推荐文章</div>
		  <div :style='{"width":"100%","padding":"20px","background":"#fff","justifyContent":"space-around","display":"flex","height":"auto"}'>
		    <div v-for="item in recommendList" :key="item.id" :style='{"width":"23%","textAlign":"center","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
		      <img :style='{"width":"100%","objectFit":"cover","display":"block","height":"120px"}' :src="baseUrl + item.picture" alt="">
