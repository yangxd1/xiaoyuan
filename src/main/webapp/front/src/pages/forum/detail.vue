<template>
  <div :style='{"width":"1200px","padding":"20px","margin":"150px auto 20px","position":"relative","background":"rgb(255, 255, 255)"}'>
    <div :style='{"width":"100%"}'>
		<div :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"100%","lineHeight":"54px","fontSize":"20px","height":"54px"}'>留言交流</div>
	</div>
    <div class="section-content" :style='{"width":"100%","margin":"20px auto","position":"relative","background":"rgb(255, 255, 255)"}'>
      ...
      <div :style='{"color":"#9E9E9E","padding":"20px"}' class="content-detail" v-html="detail.content"></div>
      
	  
		<div :style='{"width":"100%","padding":"20px 50px","boxShadow":"0 1px 6px 0 rgba(0, 0, 0, .1)","borderRadius":"60px","background":"#D8D8D8"}'>
			<div :style='{"padding":"0 0 20px 0","borderColor":"#efefef","alignItems":"center","borderWidth":"0 0 1px 0","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between"}'>
				...
				<el-button class="pub" type="primary" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#005fba","width":"auto","fontSize":"14px","lineHeight":"32px","height":"32px"}' @click="addComment">
			...
			<div class="comment" :style='{"width":"100%"}'>
				...
				<div class="item" :style='{"padding":"8px 15px","margin":"20px 0 0 0","alignItems":"center","color":"#666","background":"#fff","width":"100%","height":"auto"}' v-for="item in commentList" :key="item.id" @mouseenter="commentEnter(item.id)" @mouseleave="commentLeave">
					...
					<div class="btn" :style='{"width":"100%","margin":"8px 0 0 0","alignItems":"center","justifyContent":"flex-end","display":"flex","height":"40px"}'>
						<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"#005fba","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="showIndex==item.id&&showIndex1 == -1" @click="replyClick(item.id)">回复</el-button>
						<el-button :style='{"border":"1px solid #005fba","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"#005fba","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="showIndex==item.id&&userid==item.userid&&showIndex1 == -1" @click="commentDel(item.id)">删除</el-button>
					</div>
					...
					<div class="comment"  :style='{"width":"100%","padding":"0 0 0 50px"}'>
						<div class="item" :style='{"padding":"8px 0","margin":"20px 0 0 0","borderColor":"#efefef","alignItems":"center","color":"#666","background":"#fff","borderWidth":"1px 0 0 0","width":"100%","borderStyle":"solid","height":"auto"}' v-for="items in item.childs" :key="items.id" @mouseenter="commentEnter1(items.id)" @mouseleave="commentLeave1">
							...
							<div class="btn" :style='{"width":"100%","margin":"8px 0 0 0","alignItems":"center","justifyContent":"flex-end","display":"flex","height":"40px"}'>
								<el-button :style='{"border":"1px solid #005fba","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"#005fba","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="showIndex==item.id&&userid==items.userid&&showIndex1==items.id" @click="commentDel(items.id)">删除</el-button>
							</div>
						</div>
					</div>
					</template>
