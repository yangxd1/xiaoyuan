<template>
<div class="forum-preview" :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"150px auto 20px","position":"relative","background":"#fff"}'>
    <div :style='{"width":"100%"}'>
		<div :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"100%","lineHeight":"54px","fontSize":"20px","height":"54px"}'>留言交流</div>
	</div>
    <el-form :style='{"padding":"10px","margin":"10px 0","alignItems":"center","flexWrap":"wrap","background":"#E4F2FF","display":"flex","width":"100%","height":"auto"}' :inline="true" :model="formSearch" class="list-form-pv">
	...
	<div class="z-box" :style='{"width":"100%","padding":"20px","boxShadow":" 0px 4px 10px 0px rgba(0,0,0,0.3)"}'>
		<div class="section-content" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
		  <div :style='{"color":"#313131","flex":"6","fontSize":"14px"}' class="item-style">{{item.title}}</div>
		  <div :style='{"fontSize":"14px","color":"#333","flex":"1.5","order":"2"}' class="item-style">发布人：{{item.username}}</div>
		  <div :style='{"fontSize":"14px","color":"#333","flex":"2","order":"1"}' class="item-style">{{item.addtime}}</div>
		</div>
	</div>
