...
<div>
	<div :style='{"width":"1200px","padding":"20px","margin":"0px auto","borderRadius":"27px","background":"#fff"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'Ξ'" :style='{"fontSize":"14px","lineHeight":"1"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/shetuanxinwen"><a>{{item.name}}</a></el-breadcrumb-item>
		...
		<div class="attr" :style='{"width":"50%","padding":"0 20px","position":"relative","display":"flex","order":"1"}'>
			...
			<div class="info" :style='{"padding":"10px","margin":"0","background":"#fff","flex":"1"}'>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","alignItems":"center","background":"#fff","justifyContent":"space-between","display":"flex"}'>
					...
					<div @click="storeup(1)" v-show="!isStoreup" :style='{"borderRadius":"20px","padding":"10px","background":"#005FBA"}'><i v-if="true" :style='{"color":"#fff","fontSize":"14px"}' class="el-icon-star-off"></i><span :style='{"color":"#fff","fontSize":"14px"}'>点我收藏({{detail.storeupnum}})</span></div>
					<div @click="storeup(-1)" v-show="isStoreup" :style='{"borderRadius":"20px","padding":"10px","background":"#005FBA"}'><i v-if="true" :style='{"color":"#fff","fontSize":"14px"}' class="el-icon-star-on"></i><span :style='{"color":"#fff","fontSize":"14px"}'>取消收藏({{detail.storeupnum}})</span></div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>社团名称</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","flex":"1","height":"40px"}'>{{detail.shetuanmingcheng}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","flex":"1","height":"40px"}'>{{detail.fabushijian}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>社长账号</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","flex":"1","height":"40px"}'>{{detail.shezhangzhanghao}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>负责人</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","flex":"1","height":"40px"}'>{{detail.fuzeren}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","flex":"1","height":"40px"}'>{{detail.clicknum}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}' v-if="centerType">
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>是否审核</div>
					<div :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","flex":"1","height":"40px"}'>{{detail.sfsh}}</div>
				</div>
				<div class="item" :style='{"padding":"2px 10px","margin":"0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}' v-if="centerType">
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>审核回复</div>
					<div :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","flex":"1","height":"40px"}'>{{detail.shhf}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"5px","outline":"none","color":"#fff","borderRadius":"4px","background":"#005FBA","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('shetuanxinwen','修改')&&detail.sfsh!='是'&&detail.sfsh!='否' " @click="editClick">修改</el-button>
					<el-button :style='{"border":"1px solid #343434","cursor":"pointer","padding":"0 10px","margin":"5px","outline":"none","color":"#000","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('shetuanxinwen','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"1px solid #343434","cursor":"pointer","padding":"0 10px","margin":"5px","outline":"none","color":"#000","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('shetuanxinwen','审核') && (detail.sfsh=='待审核'||!detail.sfsh)" @click="onSH" type="warning">审核</el-button>
					<!-- hasPay 否 -->
				</div>
			</div>
		</div>
			...
			<div class="zancai" :style='{"width":"50%","padding":"0","margin":"0 0 0 50%","background":"#fff","display":"flex","order":"1"}'>
				<div :style='{"padding":"10px 0","margin":"0","alignItems":"center","background":"#005fba","display":"flex","width":"100%","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="zan" @click="thumbsupOrCrazily(21)">
				...
				<div :style='{"padding":"10px 0","margin":"0","alignItems":"center","background":"#005fba","display":"flex","width":"100%","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="cai" @click="thumbsupOrCrazily(22)">
				...
				<div :style='{"padding":"10px 0","margin":"0","alignItems":"center","background":"#005fba","display":"flex","width":"100%","justifyContent":"center"}' v-if="isThumbsupnum" class="zan" @click="cancelThumbsupOrCrazily(21)">
					<i :style='{"color":"#fff","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-dianzan"></i>
					<span :style='{"color":"#fff","margin":"0 3px","fontSize":"14px"}'>取消赞({{detail.thumbsupnum}})</span>
				</div>
				<div :style='{"padding":"10px 0","margin":"0","alignItems":"center","background":"#005fba","display":"flex","width":"100%","justifyContent":"center"}' v-if="isCrazilynum" class="cai" @click="cancelThumbsupOrCrazily(22)">
					<i :style='{"color":"#fff","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-iconfontzan"></i>
  ...
  export default {
    ...
    methods: {
      ...
      storeup(type) {
        if (type == 1 && !this.isStoreup) {
          ...
          this.$http.post('storeup/add', this.storeupParams).then(res => {
            if (res.data.code == 0) {
			  ...
			  this.$http.post('shetuanxinwen/update', this.detail).then(res => {});
              this.$message({
                type: 'success',
                message: '收藏成功!',
                duration: 1500,
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'shetuanxinwen', userid: localStorage.getItem('userid')}}).then(res => {
    ...
    getThumbsupOrCrazilyStatus() {
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 21, refid: this.detail.id, tablename: 'shetuanxinwen', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
            ...
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 22, refid: this.detail.id, tablename: 'shetuanxinwen', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
      ...
      getDiscussList(page) {
        this.$http.get('discussshetuanxinwen/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
	  ...
	  discussDel(id){
		  this.$confirm('是否删除此评论？')
		    .then(_ => {
		      this.$http.post('discussshetuanxinwen/delete',[id]).then(res=>{
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussshetuanxinwen/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
	  ...
	  addDiscussNum(type){
		...
		// 修改
		editClick(){
			this.$router.push(`/index/shetuanxinwenAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		delClick(){
			this.$confirm('是否删除此社团新闻？')
			  .then(_ => {
			    this.$http.post('shetuanxinwen/delete', [this.detail.id]).then(res => {
			      if (res.data.code == 0) {
			        this.$message({
			          type: 'success',
			          message: '删除成功!',
